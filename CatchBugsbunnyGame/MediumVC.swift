...
class MediumVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Highscore Check
        let storedHighScore = UserDefaults.standard.object(forKey: "highscoremedium")
        ...
        bugsbunnyArray = [bugsbunny1, bugsbunny2, bugsbunny3, bugsbunny4, bugsbunny5, bugsbunny6, bugsbunny7, bugsbunny8, bugsbunny9]
        
        //Timers
        time = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(countDown), userInfo: nil, repeats: true)
        
        timeHidden = Timer.scheduledTimer(timeInterval: 0.4, target: self, selector: #selector(bugsbunnyhide), userInfo: nil, repeats: true)
        ...
        if counter == -1 {
            ...
            if self.score > self.highscore {
                ...
                let replayTebrikButton = UIAlertAction(title: "Replay", style: UIAlertAction.Style.default) { (UIAlertAction) in
                    ...
                    self.timeHidden = Timer.scheduledTimer(timeInterval: 0.4, target: self, selector: #selector(self.bugsbunnyhide), userInfo: nil, repeats: true)
                }
                ...
                UserDefaults.standard.set(self.highscore, forKey: "highscoremedium")
            }
            // Alert
